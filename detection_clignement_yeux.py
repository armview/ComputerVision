    ...
    while cap.isOpened() : #tant que ma cam exécute des images
        ...
        if ret: 
            ...
            if len(face_rects) > 0: #si un visage est détécté alors prédiction pour trouver les différents points
                ...
                ear_right_eye=shape[36:41]
                ear_left_eye=shape[42:47]
                ...
                eard=eye_aspect_ratio(ear_right_eye)
                #earg=eye_aspect_ratio_g( ear_left_eye)
                #print (eard,earg)
                print (eard)
                ...
                list_eard.append(eye_aspect_ratio(ear_right_eye))
